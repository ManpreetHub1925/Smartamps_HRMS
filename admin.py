...
from db_files.db_config import engine
...
def add_user(company_id):
    if request.method == 'POST':
        ...
        try:
            with closing(conn.begin()):
                ...
                return render_template('admin/add_user.html', company_id=company_id) # Adjust this route
    ...
    return render_template('admin/add_user.html', company_id=company_id)
